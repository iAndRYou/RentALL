...
# cursor.execute("CREATE TABLE adverts (advert_id serial PRIMARY KEY, latitude FLOAT, longitude FLOAT, date DATE, price FLOAT, author_id INT, description VARCHAR, title VARCHAR, images VARCHAR[], address VARCHAR);")
